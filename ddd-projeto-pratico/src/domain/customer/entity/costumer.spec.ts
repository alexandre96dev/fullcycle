...
import SendConsoleLog1Handler from "../handler/send-console-log-1-when-product-is-created.handler"
import SendConsoleLog2Handler from "../handler/send-console-log-2-when-product-is-created.handler"
import SendConsoleLogCostumerAddressIsChangedHandler from "../handler/send-console-log-when-costumer-address-is-changed.handler"
